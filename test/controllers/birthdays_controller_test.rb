...
class BirthdaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create birthday" do
    assert_difference('Birthday.count') do
      post birthdays_url, params: { birthday: { age: @birthday.age, dayofbirth: @birthday.dayofbirth, name: @birthday.name, sex: @birthday.sex, user_id: @birthday.user_id } }
    end
  ...
  test "should update birthday" do
    patch birthday_url(@birthday), params: { birthday: { age: @birthday.age, dayofbirth: @birthday.dayofbirth, name: @birthday.name, sex: @birthday.sex, user_id: @birthday.user_id } }
